...
//
// Every app's table is named for its event (SB_OUTCOMES), which is why this file
// is per-app and the screen that reads it is not.

import { SB_OUTCOMES } from './scoring/index.ts';
...
export const RUN_ENDING_RULES: Record<string, RunEndingRule> = SB_OUTCOMES;

export const RULES_HEADING = 'How a ride is called';
export const RULES_INTRO =
  'Every way a saddle bronc ride is scored, disqualified or lost, straight out of the rule engine this app scores with.';
