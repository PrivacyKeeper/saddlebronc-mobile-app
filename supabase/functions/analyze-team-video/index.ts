...
// analyze-team-video edge function for saddlebronc.
//
...
const SYSTEM_PROMPT =
  "You are an expert saddlebronc coach reviewing a roster athlete's run for a coaching team. " +
        ...
        messages: [
          { role: "system", content: SYSTEM_PROMPT + " JSON schema: " + JSON.stringify(ANALYSIS_SCHEMA) },
          {
            ...
            content: [
              {
                type: "text",
                text: `Analyze this saddlebronc run${athlete_name ? ` by ${athlete_name}` : ""}.`,
              },
              ...images,
            ],
          },
